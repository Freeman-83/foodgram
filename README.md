...
Проект доступен по [адресу](http://foodmaster.ddns.net/) foodmaster.ddns.net

Документация к API доступна [здесь](http://158.160.0.64/api/docs/)
...
```
https://github.com/Insnx/foodgram-project-react.git
```
